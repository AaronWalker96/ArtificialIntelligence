  ...
  [ ask patches
    [ if state = "senior" AND (count neighbors with [ state = "dead" ]) > 0
      [ let parent-genome genome
        ...
        [ set genome simple-swap-set-lenght-breed parent-genome mal-mutation-rate
          set state "junior" ]
      ]
    ]
  ]
...
to new-treatment
  set treatment-genome simple-swap-set-lenght-breed treatment-genome treatment-mutation-rate
end
@#$#@#$#@
GRAPHICS-WINDOW
210
